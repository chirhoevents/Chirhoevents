        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-200 mt-4">
            ...
            <tbody>
              ...
              <tr><td className="border p-3">Cathedral</td><td className="border p-3">$200/mo</td><td className="border p-3">5</td><td className="border p-3">1,250</td></tr>
              <tr><td className="border p-3">Shrine</td><td className="border p-3">$270/mo</td><td className="border p-3">10</td><td className="border p-3">3,000</td></tr>
  ...
  "subscription-upgrade": {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mt-4">
          <p className="text-sm">
            <strong>Example:</strong> You are on the Parish plan ($59/mo) and upgrade to Cathedral ($200/mo)
            halfway through your billing cycle. Stripe credits you ~$29.50 for the unused Parish days and
            charges ~$100 for the remaining Cathedral days. Your next full month will be billed at $200.
          </p>
        </div>
