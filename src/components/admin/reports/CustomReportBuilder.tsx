...
const DATA_SOURCES: Record<string, { label: string; description: string; registrationType: 'group' | 'individual' | 'both'; fields: FieldOption[] }> = {
  registrations: {
    ...
    fields: [
      ...
      { value: 'smallGroupRoom.buildingName', label: 'Small Group Building', category: 'Housing' },
      { value: 'smallGroupRoom.roomNumber', label: 'Small Group Room', category: 'Housing' },
      { value: 'smallGroupRoom.capacity', label: 'Small Group Room Capacity', category: 'Housing' },
      { value: 'allocatedRoomsSummary', label: 'Allocated Housing Rooms', category: 'Housing' },
  ...
  participants: {
    ...
    fields: [
      ...
      { value: 'roomAssignment.buildingName', label: 'Housing Building', category: 'Housing' },
      { value: 'roomAssignment.roomNumber', label: 'Housing Room', category: 'Housing' },
      { value: 'roomAssignment.floor', label: 'Housing Floor', category: 'Housing' },
      { value: 'roomAssignment.bedNumber', label: 'Bed Number', category: 'Housing' },
    ],
  },
  individuals: {
