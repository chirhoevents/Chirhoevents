...
export default function EditRegistrationModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      {/* Fix #M7: max-h uses dvh (dynamic viewport height) so on mobile the
          on-screen keyboard reduces the modal height too — without it, the
          Save button at the bottom gets pushed below the visible area. */}
