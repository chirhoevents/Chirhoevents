-- Run this SQL directly against the database to add confessions and info features
-- This adds the missing columns and tables needed for the confessions and info features
